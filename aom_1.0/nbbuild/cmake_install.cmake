...
file(INSTALL DESTINATION "/usr/local/lib/pkgconfig" TYPE FILE FILES "/home/icaro/pesquisa_ucpel/aom_1.0/nbbuild/aom.pc")
endif()
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE STATIC_LIBRARY FILES "/home/icaro/pesquisa_ucpel/aom_1.0/nbbuild/libaom.a")
endif()
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/icaro/pesquisa_ucpel/aom_1.0/nbbuild/aomdec")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/aomdec" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/aomdec")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/icaro/pesquisa_ucpel/aom_1.0/nbbuild/aomenc")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/aomenc" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/aomenc")
    if(CMAKE_INSTALL_DO_STRIP)
...
file(WRITE "/home/icaro/pesquisa_ucpel/aom_1.0/nbbuild/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
