...
csv_test = open('/home/grellert/testesHEVC/hm-noSIMD.csv','rb')
csv_ref = open('/home/grellert/testesVVC/vtm-noSIMD.csv','rb')
out = open("/home/grellert/pesquisa_ucpel/bd-rate/hm-vtm_noSIMD.csv","w")
